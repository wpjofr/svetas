...
async function main(){
    ...
    const myKeypair = loadWalletKey("KEYPAIR_FILE_HERE");
    const mint = new web3.PublicKey("MINT_PUBLIC_KEY_HERE");
    ...
    const dataV2 = {
        name: "Svetas",
        symbol: "SVET",
        uri: "https://raw.githubusercontent.com/wpjofr/svetas/main/metadata.json",
        // we don't need that
